...
"[project]/lib/currency-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CurrencyProvider({ children }) {
    ...
    // Buscamos la región actual basándonos en el ID del estado
    const currentRegion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CurrencyProvider.useMemo[currentRegion]": ()=>regions.find({
                "CurrencyProvider.useMemo[currentRegion]": (r)=>r.id === region
            }["CurrencyProvider.useMemo[currentRegion]"]) || regions[0]
    }["CurrencyProvider.useMemo[currentRegion]"], [
        region
    ]);
    const formatPrice = (priceInMxn)=>{
        const basePrice = Number(priceInMxn) || 0;
        // Multiplicamos por la tasa de la región actual
        const converted = basePrice * currentRegion.rate;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CurrencyContext.Provider, {
        ...
        fileName: "[project]/lib/currency-context.tsx",
        lineNumber: 32,
        columnNumber: 5
    }, this);
}
_s(CurrencyProvider, "jjfBe9A9PhfjNVLA8PuH4IpDl90=");
_c = CurrencyProvider;
const useCurrency = ()=>{
    _s1();
...
_s(CartProvider, "b6iG4peTzVPEjuOyHAGcNpP0o7Q=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
function AuthProvider({ children }) {
    ...
    const fetchUserData = async (token)=>{
        try {
            const res = await fetch('http://127.0.0.1:8000/api/videojuegos/perfil/', {
                headers: {
...
//# sourceMappingURL=_45ae6fb0._.js.map